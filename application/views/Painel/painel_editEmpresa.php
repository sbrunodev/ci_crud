    ...
    <div id="wrapper">
       ...
       ?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> <?php echo $empresa. " | Editar"; ?> </h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <?php echo form_open('painel/atualizar', 'id="form-empresa"'); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="escola" class="form-control" value="<?php echo $dados_empresa[0]->escola; ?>" placeholder="Empresa">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" class="form-control" placeholder="Email" value="<?php echo $dados_empresa[0]->email; ?>"  >
                                        ...
                                        <div class="form-group" for="senha">
                                           <label>Senha</label>
                                            <input type="text" name="senha" type="password" class="form-control" value="<?php echo $dados_empresa[0]->senha; ?>"  placeholder="Senha">
